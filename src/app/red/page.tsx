...
export default function HomeRed() {
    ...
    const initFocus = () => {
        ...
        // @ts-ignore
        focus.style.background = `radial-gradient(600px at ${50}px ${50}px, rgba(231, 0, 11, 0.12), transparent 80%)`;

        document.addEventListener("mousemove", function (e) {
            let x: number = e.pageX;
            let y: number = e.pageY;
            // @ts-ignore
            focus.style.background = `radial-gradient(600px at ${x}px ${y}px, rgba(231, 0, 11, 0.12), transparent 80%)`;
        })
    }
    ...
    // ─── Matte deep red palette ───────────────────────────────────────────────
    // bg matte-red · surfaces matte-red-surface / matte-red-raised · accent rose-400
    const skillsWrap = "mt-2 flex flex-wrap";
    const skillItem = "mr-1.5 mt-2";
    const skillPill = "flex items-center rounded-full px-3 py-1 text-xs font-medium leading-5 bg-rose-100/5 text-rose-200 ring-1 ring-inset ring-rose-100/10";
    const skillPillExt = "flex items-center rounded-full px-3 py-1 text-xs font-medium leading-5 bg-rose-100/[0.03] text-rose-300/70 ring-1 ring-inset ring-rose-100/5";

    const expExt = "absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-rose-100/[0.04] lg:group-hover:shadow-[inset_0_1px_0_0_rgba(255,235,235,0.06)] lg:group-hover:drop-shadow-lg";
    const projectExt = "absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-rose-100/[0.04] lg:group-hover:shadow-[inset_0_1px_0_0_rgba(255,235,235,0.06)] lg:group-hover:drop-shadow-lg";
    const linkTitle = "inline-flex items-baseline font-medium leading-tight text-rose-50 hover:text-rose-400 focus-visible:text-rose-400 text-base transition-colors";
    ...
    const itemDesc = "mt-2 text-sm leading-normal text-rose-200/60";
    const sectionTitle = "text-sm font-bold uppercase tracking-widest text-rose-200";
    const stickyBar = "sticky top-0 z-20 -mx-6 mb-4 w-screen bg-matte-red/80 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:mb-9 lg:bg-transparent lg:backdrop-blur-none";

    return (
        <main className="relative w-full h-full min-h-screen bg-matte-red text-rose-200/70">
            ...
            <div className="container mx-auto px-10 h-full lg:flex lg:justify-between lg:gap-4 z-20">
                <div className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between pt-10 lg:!py-24">
                    <div>
                        <h1 className="text-4xl font-bold tracking-tight text-rose-50 sm:text-5xl">
                            <Link href="/red">
                                Abdullah Al Fahad
                            </Link>
                        </h1>
                        <h2 className="mt-3 text-lg font-medium tracking-tight text-rose-200 sm:text-xl">
                            Senior Front-end Engineer
                        </h2>
                        <p className="mt-4 max-w-xs leading-normal text-rose-300/60">
                        ...
                        <Link
                            className="inline-flex items-baseline leading-tight text-rose-300/60 hover:text-rose-400 focus-visible:text-rose-400 font-semibold text-base group/link mt-8 transition-colors"
                                    ...
                                    return (
                                        <li key={id}>
                                            <Link className="flex items-center py-3 group" href={`#${id}`}
                                                ...
                                                <span
                                                    className={`mr-4 h-px bg-rose-900 transition-all group-hover:w-16 group-hover:bg-rose-400 group-focus-visible:w-16 group-focus-visible:bg-rose-400 motion-reduce:transition-none ${isActive ? 'w-16 bg-rose-400' : 'w-8'}`}/>
                                                <span
                                                    className={`text-xs font-bold uppercase tracking-widest group-hover:text-rose-200 group-focus-visible:text-rose-200 ${isActive ? 'text-rose-200' : 'text-rose-300/40'}`}>{label}</span>
                                            </Link>
                                        </li>
                                    );
                                })}
                    ...
                    <div>
                        <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
                            <li className="mr-5 text-xs shrink-0">
                                <Link className="block text-rose-300/60 hover:text-rose-400 transition-all"
                ...
                <div className="pt-24 lg:w-1/2 lg:py-24" id="content">
                    <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24"
                        ...
                        <div className="z-10 sm:col-span-6">
                            <p className="mb-4 text-rose-200/70">
                    ...
                    <section id="experience" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24"
                        ...
                        <div>
                                ...
                                {[
                                    ...
                                    <li key={exp.company} className="mb-12">
                                        <div
                                            ...
                                            <header
                                                className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-rose-300/40 sm:col-span-2"
                                                aria-label={exp.duration}>{exp.duration}
                                            </header>
                                            <div className="z-10 sm:col-span-6">
                                                <h3 className="font-medium leading-snug text-rose-100">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <div className="text-rose-300/70" aria-hidden="true">
                                                            {exp.role}
                                                        </div>
                                                    </div>
                                                </h3>
                            ...
                            <div className="mt-12">
                                <Link
                                    className="inline-flex items-baseline leading-tight text-rose-300/60 hover:text-rose-400 focus-visible:text-rose-400 font-semibold text-base group/link transition-colors"
                                    href="/abdullah_al_fahad_resume.pdf" target="_blank"
                                    aria-label="View Full Resume (opens in a new tab)">
                                    <span>
                                        <span className="inline-block">
                                    ...
                                    <li key={project.title} className="mb-12">
                                        <div
                                            ...
                                            <Image
                                                ...
                                                className="rounded border border-rose-100/10 transition group-hover:border-rose-400/30 sm:order-1 sm:col-span-2 sm:translate-y-1 !h-auto aspect-[16/12] object-cover object-left-top"
                                                src={project.img}/>
                                        </div>
                                    </li>
                                ))}
                                    ...
                                    <li key={post.title} className="mb-12">
                                        <div
                                            ...
                                            <Image alt={post.title} loading="lazy" width="200" height="48"
                                                   decoding="async"
                                                   className="z-10 col-span-2 rounded border border-rose-100/10 transition group-hover:border-rose-400/30 sm:col-span-2 !h-auto aspect-[16/8] object-cover object-left-top"
                                                   src={post.img}/>
                                            <div className="z-10 col-span-6">
                                                <p className="-mt-1 text-sm font-semibold leading-6 text-rose-200">{post.year}</p>
                                                <h3 className="-mt-1">
                                                    <Link className={`${linkTitle} group/link`}
                                                          href={post.href}
                                                          target="_blank" rel="noreferrer noopener"
                                    ...
                                    <li key={pkg.title} className="mb-12">
                                        <div
                                            ...
                                            <Image alt={pkg.title} loading="lazy" width="200" height="48"
                                                   ...
                                                   src={pkg.img}/>
                                            <div className="z-10 col-span-6">
                                                <p className="-mt-1 text-sm font-semibold leading-6 text-rose-200">{pkg.year}</p>
                                                <h3 className="-mt-1">
                                                    <Link className={`${linkTitle} group/link`}
                                                          href={pkg.href}
                                                          target="_blank" rel="noreferrer noopener"
                    ...
                    <footer className="max-w-md pb-16 text-sm text-rose-300/40 sm:pb-0">
                        <p>
